...
logger.warn(`-------------------- clock version ${projectVersion} startup --------------------`)
...
app.listen(process.env.PORT, () => logger.warn(`Listening on port ${process.env.PORT}!`))

process.on('SIGINT', () => {
  logger.warn('Process received SIGINT: shutting down')
  timeSaver.clearTime()
  process.exit(130)
})
